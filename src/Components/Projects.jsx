  ...
  const projects = [
    {
      ...
      dockerImage:"https://hub.docker.com/repository/docker/truimphthilak15/hey-foodies-paradise/general",
      role: "Team Lead",
      techStack: [
        "HTML",
        "CSS",
    ...
    },
    {
      ...
      dockerImage:"https://hub.docker.com/repository/docker/truimphthilak15/hey-code-converter/general",
      role: "Individual",
      techStack: [
        "HTML",
        "CSS",
                ...
                <div className={`${styles.work} project-card`}>
                  ...
                  <div className={styles.layer}>
                    ...
                    <div className={styles.icons}>
                      ...
                      {dockerImage && <a href={dockerImage} target="_blank">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="1em"
                          height="1em"
